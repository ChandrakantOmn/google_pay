...
public class PaymentsUtil {
     ...
     */
    static PaymentsClient createPaymentsClient(Activity activity) {
     ...
     */
    static PaymentDataRequest createPaymentDataRequest(TransactionInfo transactionInfo) {
        PaymentMethodTokenizationParameters.Builder paramsBuilder =
                PaymentMethodTokenizationParameters.newBuilder()
                        ...
                        .addParameter("gatewayMerchantId", Constants.MERCHANTID);
