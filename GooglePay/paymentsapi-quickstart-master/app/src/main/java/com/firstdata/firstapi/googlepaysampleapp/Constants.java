...
import static com.google.android.gms.wallet.WalletConstants.PAYMENT_METHOD_TOKENIZED_CARD;
...
//            "GB"
   ...
   // public static final String MERCHANTID = "7438-2477-4358";//CERT
   public static final String MERCHANTID = "3176752955";//CERT
    ...
    public static final List<Pair<String, String>> GATEWAY_TOKENIZATION_PARAMETERS = Arrays.asList(
            Pair.create("gatewayMerchantId", "993216554887")
    );
/*
    public static final List<Pair<String, String>> GATEWAY_TOKENIZATION_PARAMETERS = Arrays.asList(
            Pair.create("gatewayMerchantId", "993216554887")
...
*/
    ...
    public static final String DIRECT_TOKENIZATION_PUBLIC_KEY = "J2V2+MuUinvM0hT48He9jBdhmmuaIOoZMQodGBoLMzE=";
